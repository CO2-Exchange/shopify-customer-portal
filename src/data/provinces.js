// source: https://github.com/elgambet/countries-provinces/blob/master/data/provinces.json
...
export const provinces = [
  ...
  export function byCountry(country) {
    return provinces.filter(x => x.country.toLowerCase() === country.toLowerCase())
  }
