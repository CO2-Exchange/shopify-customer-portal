...
function UpdateAddressModal({
  ...
  return (
    <div
      ...
      class='fixed top-0 left-0 right-0 z-50 w-full p-4 overflow-x-hidden overflow-y-auto tablet-sm:inset-0 h-[calc(100%-1rem)] tablet-sm:h-full px-4'
    >
      <div class='relative w-full h-full max-w-2xl tablet-sm:h-auto  mx-auto'>
        ...
        '
          ...
          <div class='flex items-center p-6 space-x-2 border-t border-gray-200 rounded-b dark:border-gray-600'>
            ...
            <button
              ...
              data-modal-hide='addressModal'
              type='button'
              class='text-blue-760 bg-white hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-blue-300 rounded-lg border border-gray-200 text-sm font-medium px-5 py-2.5 hover:text-gray-900 focus:z-10 dark:bg-gray-700 dark:text-gray-300 dark:border-gray-500 dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-600'
            >
              Cancel
            </button>
          </div>
